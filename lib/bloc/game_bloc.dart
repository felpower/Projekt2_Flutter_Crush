...
class GameBloc implements BlocBase {
  ...
  final PublishSubject<GameController> _streamGameController =
      PublishSubject<GameController>();

  Stream<GameController> get streamGameController =>
      _streamGameController.stream;
