import 'package:bachelor_flutter_crush/game_widgets/stream_objective_item.dart';
            ...
            return Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      width: 5.0, color: Colors.black.withOpacity(0.5)),
                ),
                height: 80.0,
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children:
                      snapshot.data!.level.objectives.map((Objective obj) {
                    return Padding(
