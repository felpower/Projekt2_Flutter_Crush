...
namespace Match3 {
	...
	public class SceneInfo {
		...
		public SceneInfo(string level, string type, string orientation, string powerUp, string levelName, int xDim,
			int yDim, int numMoves, int score1, int score2, int score3, int targetScore, int timeInSeconds,
			int numOfObstacles, string[] obstacleTypes) {
			this.level = level;
			this.type = type;
	...
	public static class SceneInfoExtensions {
		...
		public static SceneInfo GetAsSceneInfo() {
			return new SceneInfo(level, type, orientation, powerUp, levelName, xDim, yDim, numMoves, score1, score2,
				score3, targetScore, timeInSeconds, numOfObstacles, obstacleTypes);
		}
